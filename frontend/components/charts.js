...
import { getVennDiagramData, getTableData, getBarData } from '../actions'
...
class Charts extends React.Component {
  componentDidMount() {
    ...
    this.props.updateBarData(bar_data)
        ...
        <div style={styles.page}>
          ...
          <div style={styles.container}>
            ...
            <Card style={styles.bar_chart}>
              ...
              <DurationBarChart data={this.props.barData} />
            </Card>
          </div>
