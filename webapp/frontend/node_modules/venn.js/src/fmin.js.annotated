...
export function fmin(f, x0, parameters) {
    ...
    var maxIterations = parameters.maxIterations || x0.length * 200,
        ...
        zeroDelta = parameters.zeroDelta || 0.00025,
    ...
    for (var iteration = 0; iteration < maxIterations; ++iteration) {
        ...
        if (reflected.fx <= simplex[0].fx) {
            ...
            if (expanded.fx < reflected.fx) {
                console.log(iteration + " expand");
                temp = simplex[N];
                simplex[N] = expanded;
                expanded = temp;
            }  else {
                console.log(iteration + " replace");
                temp = simplex[N];
                simplex[N] = reflected;
                reflected = temp;
            }
        ...
        // contract
            ...
            if (reflected.fx > worst.fx) {
                ...
                if (contracted.fx < worst.fx) {
                    console.log(iteration + " inside contraction");
                    temp = simplex[N];
                ...
                if (contracted.fx <= reflected.fx) {
                    console.log(iteration + " outside contraction");
                    temp = simplex[N];
                    simplex[N] = contracted;
                    contracted = temp;
                } else {
            ...
            if (shouldReduce) {
                ...
                console.log(iteration + " reduction");
