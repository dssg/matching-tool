...
def upgrade():
    ...
    sa.Column('validate_complete_time', sa.DateTime(), nullable=True),
    sa.Column('validate_status', sa.Boolean(), nullable=True),
    sa.Column('upload_start_time', sa.DateTime(), nullable=True),
    sa.Column('upload_complete_time', sa.DateTime(), nullable=True),
    sa.Column('upload_status', sa.Boolean(), nullable=True),
